...
?>
    ...
    <div class="container pt-3">
        ...
        <div class="row">
            <div style="text-align:center;color:black;font-size:22px;font-weight:700;">Tanatan Job :
                tanatan.com All Government Jobs Online Form at Tanatan Job 2023</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 p-1">
                <div style="border: solid 3px; color:black">
                    <h2 style="background-color: black;color:white;text-align:center;font-weight: 700;">Health Care Jobs
                    </h2>
                    <?php
      $data = mysqli_query($con,"SELECT * FROM `certificate_link`");
