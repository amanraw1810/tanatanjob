...
if(isset($add_link))
{
    ...
    if($ext=="jpg" or $ext=="png" or $ext=="webp")
    {
        ...
        {
            $sql="INSERT INTO `misslaneous_link`(`cat_name`, `m_link`, `m_name`, `m_details`, `pic`) VALUES ('$cat_name','$miss_link','$miss_name','$miss_details','$upload1')";
            ...
            <div class="container p-5">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Missnameous Link Name</span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Misslaneous Link</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                    ...
                    <input type="submit" value="Submit" class="form-control btn btn-success" name="add_link">
                </form>
            </div>
            <table class="table">
                <thead>
                ...
                <tbody>
                    <?php
                                                $sql="SELECT * FROM `misslaneous_link`";
                    ...
                    <tr>
                        ...
                        <td><a href="miss_update.php?updateid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Update
                                </button>
                            </a></td>
                        <td><a href="miss_delete.php?deleteid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Delete
                                </button>
                            </a></td>
