...
if(isset($addsyllabus_link))
{
    ...
    if($ext=="jpg" or $ext=="png" or $ext=="webp")
    {
        ...
        {
            $sql="INSERT INTO `syllabus_link`(`cat_name`, `s_link`, `s_name`, `s_details`, `pic`) VALUES ('$cat_name','$s_link','$s_name','$s_details','$upload1')";
            if(mysqli_query($con,$sql))
            {
                // header("location:Brand.php");
                $msg="admit card Inserted Successfully !";
            }  	
            ...
            <div class="container p-5">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Syllabus Link</span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Syllabus Name</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="s_link">
                    </div>

                    <div class="input-group mb-3">
                        <textarea cols="30" rows="10" class="form-control" name="s_details" id="texteditor"></textarea>
                        <script>
                        tinymce.init({
                            selector: '#texteditor',
                    ...
                    <input type="submit" value="Submit" class="form-control btn btn-success" name="addsyllabus_link">
                </form>
            </div>
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $s_link; ?></td>
                        <td><?php echo $s_name; ?></td>
                        <td><a href="syllabus_update.php?updateid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Update
                                </button>
                            </a></td>
                        <td><a href="syllabus_delete.php?deleteid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Delete
                                </button>
                            </a></td>
