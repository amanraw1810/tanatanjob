        ...
        <div class="content">
            ...
            {  
                ...
                $ak_details=$_POST['ak_details'];
                       ...
                       $sql="UPDATE `answer_key` SET `ak_id`='$id',`cat_name`='$cat_name',`ak_link`='$ak_link',`ak_name`='$ak_name',`ak_details`='$ak_details' WHERE ak_id=$id;";
        ...
        ?> <div class="container p-5">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Police/defence Name</span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">police/defence Link</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
