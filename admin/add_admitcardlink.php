...
if(isset($addadmitcard_link))
{
    ...
    if($ext=="jpg" or $ext=="png" or $ext=="webp")
    {
        ...
        {
            $sql="INSERT INTO `admit_card_link`(`cat_name`, `ac_link`, `ac_name`, `ac_details`, `pic`) VALUES ('$cat_name','$link','$link_name','$ac_details','$upload1')";
...
?>
            <div class="container p-5">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <textarea cols="30" rows="10" class="form-control" name="ac_details" id="texteditor"></textarea>
                        <script>
                        tinymce.init({
                            selector: '#texteditor',
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                                                $sql="SELECT * FROM `admit_card_link`";
                    ...
                    <tr>
                        ...
                        <td><?php echo $ac_link; ?></td>
                        <td><?php echo $ac_name; ?></td>

                        <td><a href="admitcard_update.php?updateid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Update
                                </button>
                            </a></td>

                        <td><a href="admitcard_delete.php?deleteid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Delete
                                </button>
                            </a></td>
