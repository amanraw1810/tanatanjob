...
if(isset($addimp_link))
{
    ...
    if($ext=="jpg" or $ext=="png" or $ext=="webp")
    {
        ...
        {
            $sql="INSERT INTO `imp_link`(`cat_name`, `imp_link`, `imp_name`, `imp_details`, `pic`) VALUES ('$cat_name','$imp_link','$imp_name','$imp_details','$upload1')";
            ...
            <div class="container p-5">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Important Link Name</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="imp_name">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Important Link</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="imp_link">
                    </div>


                    <div class="input-group mb-3">
                        <textarea cols="30" rows="10" class="form-control" name="imp_details"
                    ...
                    <input type="submit" value="Submit" class="form-control btn btn-success" name="addimp_link">
                </form>
            </div>
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $imp_link; ?></td>
                        <td><?php echo $imp_name; ?></td>
                        <td><a href="implink_update.php?updateid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Update
                                </button>
                            </a></td>
                        <td><a href="implink_delete.php?deleteid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Delete
                                </button>
                            </a></td>
