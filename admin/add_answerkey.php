...
if(isset($add_anshwerkey))
{
    ...
    if($ext=="jpg" or $ext=="png" or $ext=="webp")
    {
        ...
        {
            $sql="INSERT INTO `answer_key`(`cat_name`, `ak_link`, `ak_name`, `ak_details`, `pic`) VALUES ('$cat_name','$ak_link','$ak_name','$ak_details','$upload1')";
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="ak_name">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Job Link</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="ak_link">
                    </div>

                    <div class="input-group mb-3">
                        <textarea cols="30" rows="10" class="form-control" name="ak_details" id="texteditor"></textarea>
                        <script>
                        tinymce.init({
                            selector: '#texteditor',
                    ...
                    <input type="submit" value="Submit" class="form-control btn btn-success" name="add_anshwerkey">
                </form>
            </div>
            <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $ak_link; ?></td>
                        <td><?php echo $ak_name; ?></td>
                        <td><a href="answerkey_update.php?updateid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    update
                                </button>
                            </a></td>

                        <td><a href="answerkey_delete.php?deleteid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Delete
                                </button>
                            </a></td>
