        ...
        <div class="content">
            ...
            {  
                ...
                $lj_details=$_POST['lj_details'];
                       ...
                       $sql="UPDATE `latest_jobs_link` SET `lj_id`='$id',`cat_name`='$cat_name',`lj_link`='$lj_link',`lj_name`='$lj_name',`lj_details`='$lj_details' WHERE lj_id=$id";
