...
if(isset($addadmission_link))
{
    ...
    if($ext=="jpg" or $ext=="png" or $ext=="webp")
    {
        ...
        {
            $sql="INSERT INTO `admission_link`(`cat_name`, `ad_link`, `ad_name`, `ad_details`, `pic`) VALUES ('$cat_name','$ad_link','$ad_name','$ad_details','$upload1')";
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Admission Link</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="ad_name">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Admission Name</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="ad_link">
                    </div>

                    <div class="input-group mb-3">
                        <textarea cols="30" rows="10" class="form-control" name="ad_details" id="texteditor"></textarea>
                        <script>
                        tinymce.init({
                            selector: '#texteditor',
                    ...
                    <input type="submit" value="Submit" class="form-control btn btn-success" name="addadmission_link">
                </form>
            </div>
            <table class="table">
                <thead>
                ...
                <tbody>
                    <?php
                                                $sql="SELECT * FROM `admission_link`";
                    ...
                    <tr>
                        ...
                        <td><?php echo $ad_link; ?></td>
                        <td><?php echo $ad_name; ?></td>
                        <td><a href="admission_update.php?updateid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Update
                                </button>
                            </a></td>

                        <td><a href="admission_delete.php?deleteid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Delete
                                </button>
                            </a></td>
