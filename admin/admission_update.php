        ...
        <div class="content">
            ...
            {  
                ...
                $ad_details=$_POST['ad_details'];
                       ...
                       $sql="UPDATE `admission_link` SET `a_id`='$id',`cat_name`='$cat_name',`ad_link`='$ad_link',`ad_name`='$ad_link',`ad_details`='$ad_details' WHERE a_id=$id;";
