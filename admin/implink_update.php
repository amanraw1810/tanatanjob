        ...
        <div class="content">
            ...
            {  
                ...
                $imp_details=$_POST['imp_details'];
                       ...
                       $sql="UPDATE `imp_link` SET `imp_id`='$id',`cat_name`='$cat_name',`imp_link`='$imp_link',`imp_name`='$imp_name',`imp_details`='imp_details' WHERE imp_id=$id";
        ...
        ?> <div class="container p-5">
                ...
                <form method="post">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Engineering Job Name</span>
