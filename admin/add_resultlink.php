...
if(isset($add_link))
{
    ...
    if($ext=="jpg" or $ext=="png" or $ext=="webp")
    {
        ...
        {
            $sql="INSERT INTO `link`(`cat_name`, `link`, `link_name`, `link_details`, `pic`) VALUES ('$cat_name','$link','$link_name','$link_details','$upload1')";
...
?>
            <div class="container p-5">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <textarea cols="30" rows="10" class="form-control" name="link_details"
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="result_update.php?updateid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Update
                                </button>
                            </a></td>
                        <td><a href="result_delete.php?deleteid=<?php echo $id; ?>">
                                <button type="button" class="btn btn-outline-primary m-2">
                                    Delete
                                </button>
                            </a></td>
