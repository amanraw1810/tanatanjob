        ...
        <div class="content">
            ...
            {  
                ...
                $s_details=$_POST['s_details'];
                       ...
                       $sql="UPDATE `syllabus_link` SET `s_id`='$id',`cat_name`='$cat_name',`s_link`='$s_link',`s_name`='$s_name',`s_details`='$s_details' WHERE s_id=$id";
        ...
        ?> <div class="container p-5">
                ...
                <form method="post">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Latest job Name</span>
