        ...
        <div class="content">
            ...
            {  
                ...
                $ac_details=$_POST['ac_details'];
                       ...
                       $sql="UPDATE `admit_card_link` SET `ac_id`='$id',`cat_name`='$cat_name',`ac_link`='$ac_link',`ac_name`='$ac_name',`ac_details`='$ac_details' WHERE ac_id=$id";
                       if(mysqli_query($con,$sql))
                          {
                           
                            echo"admit card Updated Successfully !";
                       }  	 					
                       else
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="ac_name">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default">Admit Card Link</span>
                        <input type="text" class="form-control bg-light" aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default" name="ac_link">
                    </div>
