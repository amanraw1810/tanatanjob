    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 p-1">
                <div style="border: solid 3px; color:black">
                    <h2 style="background-color: black;color:white;text-align:center;font-weight: 700;">Engeenering Jobs
                    </h2>
                    <?php
      $data = mysqli_query($con,"SELECT * FROM `imp_link`");
      ...
      ?>
                    <ul>
                        ...
                        <li> <a href="important_details.php?c_id=<?php echo $imp_link ?>"
                                style="font-size:20px;font-weight:600"><?php echo $imp_name; ?></a>
                        </li>
