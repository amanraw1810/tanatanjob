...
<body>
  ...
  ?>
    ...
    <div class="container pt-3">
        ...
        <div class="row mt-5">
            <div style="text-align:center;color:black;font-size:22px;font-weight:700;">Tanatan Jobs :
                tanatanjob.com Sarkari Naukri Latest Jobs Online Form at Tanatan Jobs 2023</div>
        </div>
        <div class="row">
    ...
    <?php
     $s_name=$_GET['s_name'];
    $data=mysqli_query($con,"SELECT * FROM `latest_jobs_link` WHERE `state`='$s_name'");
...
?>
    ...
    <ul>
        ...
        <li> <a href="job_details.php?c_id=<?php echo $lj_id; ?>"><?php echo $lj_link; ?></a></li>
