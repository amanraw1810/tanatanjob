...
<body>
   ...
   ?>
    ...
    <div class="container pt-3">
        <div class="row">
            <div class="mt-5" style="text-align:center;">
                <!--<a href="https://alkastudy.com/"> <img src="assets/gallery/alka.png" alt=""-->
    ...
    <div class="container  my-4 float-left" style="border: solid 3px; color:black; width:80%  ">
        <h2 style="background-color: black;color:white;text-align:center;font-weight: 700;">Police/Defence Jobs</h2>
        <?php
      $data = mysqli_query($con,"SELECT * FROM `admission_link`ORDER by a_id desc");
      ...
      ?>
        <ul>
            ...
            <li> <a href="admission_details.php?c_id=<?php echo $a_id; ?>"
                    style="font-size:20px;font-weight:600"><?php echo $ad_name; ?></a>
            </li>
