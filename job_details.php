...
<body>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      ?>
                    <ul>
                        ...
                        <li> <a href="state.php?s_name=<?php echo $state; ?>" target="_blank"><?php echo $state; ?></a>
                        </li>
    ...
    <?php
     $c_id=$_GET['c_id'];
    $data=mysqli_query($con,"SELECT * FROM `latest_jobs_link` WHERE `lj_id`='$c_id'");
...
?>
    ...
    <!--<?php echo $lj_details; ?>-->
    <div class="container table-responsive mt-4 " align="center">
        <?php echo $lj_details; ?>
    </div>
