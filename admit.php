    ...
    <div class="container" style="width:80%;">
        <div class="row">
            <div class="col-md-12 p-1">
                <div style="border: solid 3px; color:black">
                    ...
                    <?php
      $data = mysqli_query($con,"SELECT * FROM `admit_card_link` ORDER by ac_id desc");
      ...
      ?>
                    <ul>
                        ...
                        <li> <a href="admit_card_details.php?c_id=<?php echo $ac_id; ?>"
                                style="font-size:20px;font-weight:600"><?php echo $ac_name; ?></a>
                        </li>
