...
?>
    ...
    <div class="container" style="width:80%">
        <div class="row">
            <div class="col-md-12 p-1">
                <div style="border: solid 3px; color:black">
                    <h2 style="background-color: black;color:white;text-align:center;font-weight: 700;">Result</h2>
                    <?php
      $data = mysqli_query($con,"SELECT * FROM `link` ORDER BY link_id desc");
      ...
      ?>
                    <ul>
                        ...
                        <li> <a href="result_details.php?c_id=<?php echo $link_id ; ?>"
                                style="font-size:20px;font-weight:600"><?php echo $link_name; ?></a>
                        </li>
      ...
      ?>
                    <!--<input type="submit" value="Read More" class="text-center btn btn-danger px-3 mx-3">-->
                </div>
            </div>
        </div>
    </div>
