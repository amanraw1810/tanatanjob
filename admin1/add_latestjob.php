...
<body>
    <?php
if (isset($_POST['addlatestjobs_link'])){
  $cat_name = $_POST['cat_name'];
  $lj_name = $_POST['lj_name'];
  $lj_link = $_POST['lj_link'];
  $lj_details = $_POST['lj_details'];
  $insert_query = "INSERT INTO `latest_jobs_link`(`cat_name`, `lj_link`, `lj_name`, `lj_details`) VALUES ('$cat_name',' $lj_link',' $lj_name','$lj_details')";
    ...
    <div class="container p-5">
        ...
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Admit Latest jobs Name</span>
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Admit Latest jobs Link</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" name="lj_link">
            </div>

            <div class="input-group mb-3">
                <textarea class="form-control" name="lj_details" id="editor1"></textarea>
            </div>
