...
<body>
    <?php
if (isset($_POST['add_anshwerkey'])){
  $cat_name = $_POST['cat_name'];
  $ak_name = $_POST['ak_name'];
  $ak_link = $_POST['ak_link'];
  $ak_details = $_POST['ak_details'];
  $insert_query = "INSERT INTO `answer_key`(`cat_name`, `ak_link`, `ak_name`, `ak_details`) VALUES ('$cat_name',' $ak_link','$ak_name','$ak_details')";
    ...
    <div class="container p-5">
        ...
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Answer key Name</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" name="ak_name">
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Answer key Link</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" name="ak_link">
            </div>

            <div class="input-group mb-3">
                <textarea class="form-control" name="ak_details" id="editor1"></textarea>
            </div>
