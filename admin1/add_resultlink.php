...
if (isset($_POST['add_link'])) {
  ...
  $insert_query = "INSERT INTO `link`(`cat_name`, `link`, `link_name`, `link_details`) VALUES ('$cat_name','$link','$link_name','$link_details')";
...
?>
    <div class="container p-5">
        ...
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <textarea class="form-control" name="link_details" id="editor1"></textarea>
            </div>
