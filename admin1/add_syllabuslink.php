...
<body>
    <?php
if (isset($_POST['addsyllabus_link'])){
  $cat_name = $_POST['cat_name'];
  $s_name = $_POST['s_name'];
  $s_link = $_POST['s_link'];
  $s_details = $_POST['s_details'];
  $insert_query = "INSERT INTO `syllabus_link`(`cat_name`, `s_link`, `s_name`, `s_details`) VALUES ('$cat_name','$s_name',' $s_link',' $s_details')";
...
?>
    <div class="container p-5">
        ...
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <textarea class="form-control" name="s_details" id="editor1"></textarea>
            </div>
