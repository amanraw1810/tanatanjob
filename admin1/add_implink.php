...
<body>
    <?php
if (isset($_POST['addimp_link'])){
  $cat_name = $_POST['cat_name'];
  $imp_name = $_POST['imp_name'];
  $imp_link = $_POST['imp_link'];
  $imp_details = $_POST['imp_details'];
  $insert_query = "INSERT INTO `imp_link`(`cat_name`, `imp_link`, `imp_name`, `imp_details`) VALUES ('$cat_name','$imp_link','$imp_name','$imp_details')";
...
?>
    <div class="container p-5">
        ...
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <textarea class="form-control" name="imp_details" id="editor1"></textarea>
            </div>
