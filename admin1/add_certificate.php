...
<body>
    <?php
if (isset($_POST['addcertificate_link'])){
  $cat_name = $_POST['cat_name'];
  $ct_link = $_POST['ct_link'];
  $ct_name = $_POST['ct_name'];
  $ct_details = $_POST['ct_details'];
  $insert_query = "INSERT INTO `certificate_link`(`cat_name`, `ct_link`, `ct_name`, `ct_details`) VALUES ('$cat_name','$ct_link','$ct_name','$ct_details')";
    ...
    <div class="container p-5">
        ...
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Certificate Link</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" name="ct_link">
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Certificate Name</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
            ...
            <div class="input-group mb-3">
                <textarea class="form-control" name="ct_details" id="editor1"></textarea>
            </div>
