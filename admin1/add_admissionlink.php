...
<body>
    <?php
if (isset($_POST['addadmission_link']))
{
  $cat_name = $_POST['cat_name'];
  $ad_name = $_POST['ad_name'];
  $ad_link = $_POST['ad_link'];
  $ad_details = $_POST['ad_details'];
  $insert_query = "INSERT INTO `admission_link`(`cat_name`, `ad_link`, `ad_name`, `ad_details`) VALUES              ('$cat_name','$ad_name','$ad_link','$ad_details')";
...
?>
    <div class="container p-5">
        ...
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <textarea class="form-control" name="ad_details" id="editor1"></textarea>
            </div>
