        ...
        <div class="row">
            <div class="col-md-12 p-1">
                <div style="border: solid 3px; color:black">
                    <h2 style="background-color: black;color:white;text-align:center;font-weight: 700;">12<sup></sup>th
                        Level Jobs</h2>
                    <?php
      $data = mysqli_query($con,"SELECT * FROM `answer_key`ORDER by ak_id desc ");
      ...
      ?>
                    <ul>
                        ...
                        <li> <a href="anshwer_details.php?c_id=<?php echo $ak_id; ?>"
                                style="font-size:20px;font-weight:600"><?php echo $ak_name; ?></a>
                        </li>
